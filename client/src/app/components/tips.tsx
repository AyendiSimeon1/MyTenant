          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="p-6 bg-white rounded-lg shadow-lg">
                <img src="/images/tip1.jpg" alt="Tip 1" className="rounded mb-4"/>
            ...
            <div>
              <div className="p-6 bg-white rounded-lg shadow-lg">
                <img src="/images/tip2.jpg" alt="Tip 2" className="rounded mb-4"/>
            ...
            <div>
              <div className="p-6 bg-white rounded-lg shadow-lg">
                <img src="/images/tip3.jpg" alt="Tip 3" className="rounded mb-4"/>
